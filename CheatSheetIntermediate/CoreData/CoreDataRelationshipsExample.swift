...
class CoreDataRelationshipViewModel: ObservableObject {
    ...
    func addBusiness() {
        ...
        // add existing departments/employees to new business
        // newBusiness.departments = [departments[0],departments[1]]
        // newBusiness.employees = [employees[2], employees[3]]
        
        // add a new business to existing department/employee
...
struct CoreDataRelationshipsExample_Previews: PreviewProvider {
